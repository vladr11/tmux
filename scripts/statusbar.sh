...
main()
{
  ...
  show_battery=$(get_tmux_option "@statusbar-show-battery" true)
  show_network=$(get_tmux_option "@statusbar-show-network" true)
  show_weather=$(get_tmux_option "@statusbar-show-weather" true)
  show_fahrenheit=$(get_tmux_option "@statusbar-show-fahrenheit" true)
  show_location=$(get_tmux_option "@statusbar-show-location" true)
  show_powerline=$(get_tmux_option "@statusbar-show-powerline" false)
  show_flags=$(get_tmux_option "@statusbar-show-flags" false)
  show_left_icon=$(get_tmux_option "@statusbar-show-left-icon" smiley)
  show_left_icon_padding=$(get_tmux_option "@statusbar-left-icon-padding" 1)
  show_military=$(get_tmux_option "@statusbar-24h-time" true)
  show_timezone=$(get_tmux_option "@statusbar-show-timezone" true)
  show_left_sep=$(get_tmux_option "@statusbar-show-left-sep" )
  show_right_sep=$(get_tmux_option "@statusbar-show-right-sep" )
  show_border_contrast=$(get_tmux_option "@statusbar-border-contrast" false)
  show_cpu_usage=$(get_tmux_option "@statusbar-cpu-usage" false)
  show_ram_usage=$(get_tmux_option "@statusbar-ram-usage" false)
  show_gpu_usage=$(get_tmux_option "@statusbar-gpu-usage" false)
  show_day_month=$(get_tmux_option "@statusbar-day-month" false)
  show_time=$(get_tmux_option "@statusbar-show-time" true)
  show_refresh=$(get_tmux_option "@statusbar-refresh-rate" 5)
